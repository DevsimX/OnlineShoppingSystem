"""
Django settings for OnlineShoppingSystem project.
"""
...
SIMPLE_JWT = {
    ...
    'BLACKLIST_AFTER_ROTATION': False,  # Disabled since we don't have blacklist app installed
}

# CORS settings
# Support both environment variable and default localhost origins
